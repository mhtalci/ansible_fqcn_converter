...
""")
    ...
    def test_error_handling_examples(self, temp_dir):
        ...
        from fqcn_converter.exceptions import ConversionError, ValidationError, FileAccessError
        ...
        try:
            ...
            assert isinstance(e, (ConversionError, FileAccessError, FileNotFoundError, OSError))
        ...
        try:
            ...
            # This is expected behavior
            assert isinstance(e, (ValidationError, FileAccessError, FileNotFoundError, OSError))
...
""")
        ...
        assert batch_duration < 30.0, f"Batch processing took too long: {batch_duration:.2f}s"
...
""")
        ...
        batch_results = batch_processor.process_projects([str(project_dir)], dry_run=True)
