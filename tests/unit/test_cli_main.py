...
from fqcn_converter.cli.main import create_parser, main, setup_logging
...
class TestMainFunction:
    ...
    def test_main_no_command(
        self, mock_setup_logging, mock_create_parser, mock_preprocess_args
    ):
    ...
    def test_main_validate_command(
        ...
        mock_parser.parse_args.return_value = mock_args
        mock_create_parser.return_value = mock_parser
        mock_preprocess_args.return_value = (
            [],
            "verbose",
        )  # Return verbose from preprocessing
    ...
    def test_main_keyboard_interrupt(
        self, mock_convert_main, mock_setup_logging, mock_create_parser
    ):
    ...
    @patch("fqcn_converter.cli.main.setup_logging")
    @patch("fqcn_converter.cli.convert.main")
    def test_main_exception_with_verbose_logging(
        self,
        mock_convert_main,
        mock_setup_logging,
        mock_create_parser,
