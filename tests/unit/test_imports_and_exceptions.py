...
def test_package_imports():
    ...
    # Test core imports
    from fqcn_converter.core import converter, validator, batch
    ...
    # Test CLI imports
    from fqcn_converter.cli import main, convert, validate, batch as cli_batch
    ...
    from fqcn_converter.exceptions import (
        FQCNConverterError, ConversionError, ValidationError,
        FileAccessError, ConfigurationError, YAMLParsingError,
...
def test_yaml_handler_utils():
    ...
    from fqcn_converter.utils.yaml_handler import safe_load, safe_dump
